...
pylab.savefig('rms_train_error.png')
...
pylab.savefig('rms_test_accuracy.png')
...
for sample in range(2):
    ...
    pylab.savefig('rms'+str(sample)+'_question1_input.png')
    ...
    pylab.savefig('rms'+str(sample)+'_question1_convolution1.png')
   ...
   # pylab.title('pooled feature maps')
    pylab.savefig('rms'+str(sample)+'_question1_pooling1.png')
    ...
    #pylab.title('convolved feature maps')
    pylab.savefig('rms'+str(sample)+'_question1_convolution2.png')
    ...
    #pylab.title('pooled feature maps')
    pylab.savefig('rms'+str(sample)+'_question1_pooling2.png')
